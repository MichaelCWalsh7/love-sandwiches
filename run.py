...
def validate_data(values):
    ...
    or if there aren't exactly 6 vaules.
    """
    try:
...
def calculate_surplus_data(sales_row):
    ...
    - Negative surplu sindicates extra made when stock was sold out
    """
...
def get_last_5_entries_sales():
    """
    Collects columns of data from each sales worksheet, collecting the
    last 5 entires for each sandwich and returns the data as a list of
    lists.
    """
